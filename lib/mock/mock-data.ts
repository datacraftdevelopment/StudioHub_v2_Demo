...
export const mockDeliverables: MockDeliverable[] = [
  ...
  // Additional deliverable for admin user
  {
    id: 'H99999-01',
    title: 'Graphics Department Review',
    dueDate: getRelativeDate(1),
    status: 'Pending',
    displayStatus: 'Pending',
    project: '21-1543 Walmart / Retail Display Update',
    projectId: 'P002',
    client: 'Walmart',
    studioRequestNumber: 'SR-2024-099',
    studioRequestId: 'SR099',
    assignedTo: 'Administrator',
    assignedRole: 'Manager',
    assignedDepartment: 'Graphics',
    category: 'Review',
    notes: 'Monthly department review and planning session',
    studioRequestCreated: getRelativeDate(-2),
    studioRequestStatus: 'Active',
    studioRequestDescription: 'Quarterly graphics department performance and resource review',
